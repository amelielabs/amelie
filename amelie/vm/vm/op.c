...
OpDesc ops[] =
{
	...
	{ CPUSH_TIMESTAMP_CURRENT, "push_timestamp_current" },
	{ CPUSH_DATE, "push_date" },
	{ CPUSH_DATE_CURRENT, "push_date_current" },
	...
	{ CTIMESTAMP_CURRENT, "timestamp_current" },
	{ CDATE, "date" },
	{ CDATE_CURRENT, "date_current" },
	{ CVECTOR, "vector" },
	{ CUUID, "uuid" },
	{ CVALUE, "value" },
